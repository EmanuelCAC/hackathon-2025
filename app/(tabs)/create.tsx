        ...
        if (i === dayIndex) {
          return {
            ...
            data: dia.data.map((place, j) =>
              j === placeIndex
                ? { ...place, place: newPlace, placeId: newPlaceId }
                : place
            ),
          };
        }
    ...
    <SafeAreaView className="flex-1">
      ...
      >
        <Text className="text-3xl font-semibold text-center my-5">
          Crie seu Próprio Roterio de Viagem
        </Text>
        <View className="flex flex-col items-start w-full">
          <Text className="text-2xl font-semibold p-2 pl-4">
            Nome do Roteiro:
          </Text>
          <TextInput
        ...
        <View className="flex flex-col items-start w-full">
          <Text className="text-2xl font-semibold p-2 pl-4">
            Descrição:{" "}
            <Text className="text-2xl text-gray-400">(opicional)</Text>
          </Text>
          <TextInput
            className="rounded-full font-bold mb-4 bg-white border-2 border-secondary w-full text-xl p-4 pl-8"
            placeholderTextColor={"#d69600"}
        ...
        <View className="flex flex-row ml-auto mr-5 mb-10 gap-3">
          ...
          >
            <Text className="text-2xl text-white font-semibold">Limpar</Text>
          </TouchableOpacity>
          <TouchableOpacity
            className="bg-primary p-2 px-4 rounded-lg"
            onPress={handelSave}
          >
            <Text className="text-2xl text-white font-semibold">Salvar</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView>
